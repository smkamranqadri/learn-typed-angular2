        ...
        execute: function() {
            todosComponent = (function () {
                function todosComponent() {
                    this.todos = [];
                    this.todos.push(new todo_1.Todo(this.todos.length + 1, 'Task 1', true));
                    this.todos.push(new todo_1.Todo(this.todos.length + 1, 'Task 2', false));
                    this.todos.push(new todo_1.Todo(this.todos.length + 1, 'Task 3', true));
                    this.todos.push(new todo_1.Todo(this.todos.length + 1, 'Task 4', true));
                    this.todos.push(new todo_1.Todo(this.todos.length + 1, 'Task 5', false));
                }
                todosComponent.prototype.addTodo = function (task) {
                    if (task.value) {
                        this.todos.push(new todo_1.Todo(this.todos.length + 1, task.value, false));
                        task.value = '';
                    }
                };
